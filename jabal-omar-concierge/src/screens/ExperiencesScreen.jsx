...
const EXPERIENCES = [
  ...
  {
    id: 'convention',
    title: 'Abdulrahman Fakieh Convention Centre',
    titleAr: 'مركز عبدالرحمن فقيه للمؤتمرات',
    tagline: 'World-class events & conferences',
    taglineAr: 'فعاليات ومؤتمرات عالمية المستوى',
    desc: 'The Abdulrahman Fakieh Convention Centre — a state-of-the-art facility within Jabal Omar hosting international conferences, exhibitions, and large-scale events. Equipped with the latest audiovisual technology and purpose-built event infrastructure.',
    descAr: 'مركز عبدالرحمن فقيه للمؤتمرات — مرفق متطور داخل جبل عمر يستضيف مؤتمرات ومعارض دولية وفعاليات كبرى. مجهز بأحدث التقنيات السمعية والبصرية وبنية تحتية للفعاليات.',
    location: 'Jabal Omar Complex',
    locationAr: 'مجمع جبل عمر',
    hours: 'By Booking',
    ...
    color: '#f472b6',
    features: ['2000-seat Auditorium', 'Exhibition Halls', 'Breakout Rooms', 'Full Catering'],
    featuresAr: ['قاعة ٢٠٠٠ مقعد', 'قاعات معارض', 'غرف مساعدة', 'خدمة طعام كاملة'],
    booking: true,
  },
]
